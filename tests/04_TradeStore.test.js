...
describe('TradeStore', () => {
    ...
    it('should read trades from manually written daily file', async () => {
        ...
        const trades = await store.readTradesArrayAsync(2024, 1, 1, 2024, 1, 1)
    ...
    it('should chain multiple days seamlessly', async () => {
        ...
        const store = new Trades(tmpDir, btcusdc)
        const trades = await store.readTradesArrayAsync(2024, 1, 1, 2024, 1, 3)
    ...
    it('should read pre-existing trades without downloading', async () => {
        ...
        const store = new Trades(tmpDir, btcusdc)
        const trades1 = await store.readTradesArrayAsync(2024, 1, 1, 2024, 1, 1)
        expect(trades1).to.have.length(3)
        const trades3 = await store.readTradesArrayAsync(2024, 1, 3, 2024, 1, 3)
    ...
    it('should chain across month boundaries', async () => {
        ...
        const store = new Trades(tmpDir, btcusdc)
        const trades = await store.readTradesArrayAsync(2024, 1, 31, 2024, 2, 1)
