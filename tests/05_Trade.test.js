...
const writeTrade = (buf, offset, index, tsUs, price, baseQty, quoteQty, isBuyerMaker) => {
    Trade.writeRecord(buf, offset, index, tsUs, price, baseQty, quoteQty, isBuyerMaker)
}
...
describe('Trade', () => {
    ...
    it('should read tsUs from buffer', () => {
        ...
        writeTrade(buf, 0, 42, 1704067200123456, 42000, 0.5, 21000, false)
    ...
    it('should read index from buffer', () => {
        const buf = Buffer.alloc(Trade.RECORD_SIZE)
        writeTrade(buf, 0, 12345678, 1000000, 42000, 0.5, 21000, false)
        const trade = new Trade(buf)
    ...
    it('should read price from buffer', () => {
        const buf = Buffer.alloc(Trade.RECORD_SIZE)
        writeTrade(buf, 0, 1, 1000000, 42123.45, 0.1, 4212, false)
        const trade = new Trade(buf)
    ...
    it('should read baseQty from buffer', () => {
        const buf = Buffer.alloc(Trade.RECORD_SIZE)
        writeTrade(buf, 0, 1, 1000000, 42000, 1.2345, 51869, false)
        const trade = new Trade(buf)
    ...
    it('should read quoteQty from buffer', () => {
        const buf = Buffer.alloc(Trade.RECORD_SIZE)
        writeTrade(buf, 0, 1, 1000000, 42000, 0.5, 21000.75, false)
        const trade = new Trade(buf)
    ...
    it('should read isBuyerMaker false', () => {
        const buf = Buffer.alloc(Trade.RECORD_SIZE)
        writeTrade(buf, 0, 1, 1000000, 42000, 0.5, 21000, false)
        const trade = new Trade(buf)
    ...
    it('should read isBuyerMaker true', () => {
        const buf = Buffer.alloc(Trade.RECORD_SIZE)
        writeTrade(buf, 0, 1, 1000000, 42000, 0.5, 21000, true)
        const trade = new Trade(buf)
    ...
    it('should preserve tsUs when isBuyerMaker is true', () => {
        ...
        writeTrade(buf, 0, 1, ts, 42000, 0.5, 21000, true)
        const trade = new Trade(buf)
    ...
    it('should be a view on a subarray of a larger buffer', () => {
        ...
        writeTrade(big, 0, 1, 1000000, 100, 0.1, 10, false)
        writeTrade(big, Trade.RECORD_SIZE, 2, 2000000, 200, 0.2, 40, true)
        writeTrade(big, Trade.RECORD_SIZE * 2, 3, 3000000, 300, 0.3, 90, false)
